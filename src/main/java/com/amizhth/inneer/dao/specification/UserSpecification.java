...
public class UserSpecification extends CommonSpecification implements Specification<UserModel> {

	private List<FilterCriteria> criteriaList;

	private List<FilterCriteria> searchList;

	public UserSpecification(List<FilterCriteria> filterCriterias, List<FilterCriteria> searchCriterias) {
