...
public class OrderSpecification extends CommonSpecification implements Specification<OrderModel> {

	private List<FilterCriteria> criteriaList;

	private List<FilterCriteria> searchList;

	public OrderSpecification(List<FilterCriteria> filterCriterias, List<FilterCriteria> searchCriterias) {
